...
return array(
	...
	'include_path' => array(
		APP_PATH.'/include',
		APP_PATH.'/model',
		APP_PATH.'/include/mine',
        APP_PATH.'/include/rain',
        APP_PATH.'/include/rain/inc',
		APP_PATH.'/include/top',
		APP_PATH.'/include/top/request',
APP_PATH.'/include/lotusphp_runtime',
APP_PATH.'/include/lotusphp_runtime/Autoloader',
APP_PATH.'/include/lotusphp_runtime/Cache',
APP_PATH.'/include/lotusphp_runtime/Captcha',
APP_PATH.'/include/lotusphp_runtime/ObjectUtil',
	), // 用户程序扩展类载入路径
);
